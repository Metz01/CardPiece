...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/metz/it/projects/cpp/qt/OPDeckBuilder/OpDeckBuilder/.tmp/main1.0.0
LINK          = g++
...
Don.o: models/card_types/Don.cpp models/card_types/Don.h \
		models/Card.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Don.o models/card_types/Don.cpp
