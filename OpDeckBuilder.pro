...
#Input
SOURCES+= main.cpp
SOURCES+= models/Card.cpp models/ColoredCard.cpp models/Don.cpp models/Attacker.cpp models/PlayableCard.cpp
SOURCES+= models/card_types/*.cpp
SOURCES+= widgets/Card_widget.cpp widgets/Main_Window.cpp
HEADERS+= models/Card.h models/ColoredCard.h models/Don.h models/Attacker.h models/PlayableCard.h
