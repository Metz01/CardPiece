...
const Enums::Colors EnumsHelper::getColor(int value){
...
const Enums::CardType EnumsHelper::getCardType(int value){
...
const std::string EnumsHelper::getAttributeName(Enums::InfoAttribute type){
    switch (type){
